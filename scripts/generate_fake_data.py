...
# Gerando a base de dados "Tabelas"
#   clientes
customers = []
...
df_orders_items = pd.DataFrame(order_items)
df_orders_items.to_csv(OUTPUT_PATH/"orders_items.csv", index= False)
...
print("Dados gerados com sucesso em: ", OUTPUT_PATH.resolve())
